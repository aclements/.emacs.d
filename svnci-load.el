;;; svnci-load.el --- interactive Subversion commit and status/diff/add
...
;; To install svnci, add the following lines to your .emacs file:
;;   (add-to-list 'load-path "PATH CONTAINING svnci-load.el" t)
;;   (require 'svnci-load)
;; After this, the svnci and svnci-this commands will be available.

;; See svnci.el for documentation.

;;; Code:

;; To update this file, evaluate the following form
;;   (let ((generated-autoload-file buffer-file-name)) (update-file-autoloads "svnci.el"))


;;;### (autoloads (svnci-this svnci) "svnci" "svnci.el" (18463 38710))
;;; Generated autoloads from svnci.el

(autoload (quote svnci) "svnci" "\
...
(autoload (quote svnci-this) "svnci" "\
