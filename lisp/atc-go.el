...
(defun atc:go-mode-setup ()
  ...
  (atc:want-executable "godoc" "go get code.google.com/p/go.tools/cmd/godoc")
  (atc:want-executable "godef" "go get code.google.com/p/rog-go/exp/cmd/godef")
  (when (atc:want-fbound 'go-eldoc-setup 'go-eldoc)
    (go-eldoc-setup))
  (when (and (atc:want-fbound 'company-go 'company-go)
             (atc:want-executable "gocode" "go get -u github.com/nsf/gocode"))
...
(eval-after-load 'go-mode
  (progn
    ...
    (when (atc:want-executable "goimports" "go get code.google.com/p/go.tools/cmd/goimports")
